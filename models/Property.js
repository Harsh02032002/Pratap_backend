...
const PropertySchema = new mongoose.Schema({
  ...
  // pendingChangesData: { type: mongoose.Schema.Types.Mixed },
  // pendingChangesRequestedAt: { type: Date },
  // pendingChangesRequestedBy: { type: String },
  // pendingChangesReason: { type: String },
  // pendingChangesStatus: { type: String, enum: ['pending', 'approved', 'rejected'] },
