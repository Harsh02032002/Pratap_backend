...
tenantLeaveRequestSchema.index({ tenantId: 1, createdAt: -1 });
tenantLeaveRequestSchema.index({ tenantLoginId: 1, createdAt: -1 });
tenantLeaveRequestSchema.index({ ownerLoginId: 1, createdAt: -1 });
